...
public class SeedData
{
    ...
    public void CreateUsers()
    {
        modelBuilder.Entity<Teacher>().HasData(
            new Teacher { Id = 2, Pseudo = "ben", Password = "ben", FirstName = "Benoît", LastName = "Penelle", Email = "ben@test.com" },
            new Teacher { Id = 3, Pseudo = "bruno", Password = "bruno", FirstName = "Bruno", LastName = "Lacroix", Email = "bruno@test.com" }
        );

        modelBuilder.Entity<Student>().HasData(
            new Student { Id = 4, Pseudo = "bob", Password = "bob", FirstName = "Bob", LastName = "l'Eponge", Email = "bob@test.com" },
            new Student { Id = 5, Pseudo = "caro", Password = "caro", FirstName = "Caroline", LastName = "de Monaco", Email = "caro@test.com" }
        );
    }
